...
class PartyOrderFormView extends Component{
    ...
    componentDidMount(){
        ...
        if (currentPage == 'productCartView' || currentPage == 'productDetailView')
        {
    ...
    formatFirstName(name) {
        let x = name.replace(/[(\W\d_]/g, " ").replace(/[\s]+/g, " ");
    ...
    onPressHandle1(){
        ...
        this.refs.bartender_checkbox.setState({isChecked:false});
        this.setState({
            first_name:'',
            last_name:'',
            phone_number:'',
    ...
    render(){
        ...
        let today = tomorrow.getFullYear() + '-' + (tomorrow.getMonth()+1) + '-' + (tomorrow.getDate());
            ...
            return(
				<View style={styles.bg}>
					<KeyboardAwareScrollView
						...
						style={{height:screen_height - 100, flex:1}}>
						...
						<View>
							<TextInput
								...
								placeholderTextColor="#494D4F"
								//onFocus={this.inputFocused.bind(this, 'email_address')}
								style={{height:45, backgroundColor:'#FFF',fontSize:15,paddingLeft:15,fontWeight:'bold'}}
							/>
							<View style={{borderBottomColor:'#F1F2F2',borderBottomWidth:4}}></View>
                            {
						...
						<View>
							<TextInput
								...
								placeholderTextColor="#494D4F"
								//onFocus={this.inputFocused.bind(this, 'company_name')}
								style={{height:45, backgroundColor:'#FFF',fontSize:15,paddingLeft:15,fontWeight:'bold'}}
							/>
							<View style={{borderBottomColor:'#F1F2F2',borderBottomWidth:4}}></View>
						</View>
						<View>
							<TextInput
								...
								ref='title'
								returnKeyType={"next"}
								onSubmitEditing={()=>this.refs.picker_date.onPressDate()}
								onChangeText={(title)=>this.setState({title})}
								value={this.state.title}
								placeholder={'Title'}
								placeholderTextColor="#494D4F"
								//onFocus={this.inputFocused.bind(this, 'title')}
								style={{height:45, backgroundColor:'#FFF',fontSize:15,paddingLeft:15,fontWeight:'bold'}}
							/>
							...
							<View style={{flexDirection:'row',backgroundColor:'#F1F2F2'}}>
								<View style={{flex:1,marginRight:1.5}}>
									<DatePicker
										...
										onDateChange={(date)=>{this.refs.picker_time.onPressDate(); this.setState({date: date})}}
								...
								<View style={{flex:1,marginLeft:1.5}}>
									<DatePicker
										...
										confirmBtnText="Confirm"
										cancelBtnText="Cancel"
										onDateChange={(time) => {this.refs.event_venue.focus(); this.setState({time: time})}}
					...
					<View>
						<TextInput
							...
							onFocus={this.inputFocused.bind(this, 'event_venue')}
					...
					<View>
						<TextInput
							...
							placeholderTextColor="#414042"
							onFocus={this.inputFocused.bind(this, 'experted_attendees')}
							style={{height:38, backgroundColor:'#FFF',fontSize:15,paddingLeft:15,fontWeight:'bold'}}
						/>
						<View style={{borderBottomColor:'#F1F2F2',borderBottomWidth:4}}></View>
                        {
...
export default connect(
    ...
    }),{loadSubmitResult, saveCurrentPage, savePrevPage})(PartyOrderFormView);