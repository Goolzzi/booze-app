	...
	_onSubmit(){
		...
		if(email_address){			
			...
			**/
			...
			let street= this.props.geoCodeForm.selectedList.street
			let city= this.props.geoCodeForm.selectedList.city
			let state= this.props.geoCodeForm.selectedList.state
			let zipCode= this.props.geoCodeForm.selectedList.zipCode
