...
import {AsyncStorage, Alert, StyleSheet, Image, View, Text, TouchableOpacity, ScrollView, Dimensions} from 'react-native'
...
class RefreshSearchProductView extends Component{
...
export default connect(
  	...
  	}),{loadSearchProductData, saveIsDetail, savePrevPage})(RefreshSearchProductView);
