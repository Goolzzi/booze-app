...
import {savePrevPage, saveCurrentPage, saveProductData, saveTabType, saveIsDetail} from '../redux/actions/tabInfoAction';
...
class ProductDetailView extends Component{
	...
	componentDidMount() {
		...
		console.log('prevPage on productDetailView;', prevPage);
			...
			<SideMenu
				...
				<View style={styles.bg}>
					<SearchBarView 
							...
							addFlag='true'  
							onPress={()=>this.toggle()} 
							galleryTypesID={this.props.galleryTypesID}
	  						galleryFlag={this.props.galleryFlag}
					...
					<ScrollView
						...
						<View style={styles.productViewStyle} >
				  			...
				  			<Text style={{fontSize:21, color:'#58595b', fontWeight:'bold', marginTop:20, flexDirection:'row',flexWrap: 'wrap'}}>{rowData.name}</Text>
...
export default connect(
  	...
  	}),{getCartInfo, addCartInfo, savePrevPage, saveCurrentPage, saveProductData, saveTabType, saveIsDetail})(ProductDetailView);
