...
let initialState = {orderResult: null, orderFailed:null, promocodeResult: null, promocodeFailed:null, loading:false, loadingOfPlaceOrder:false, error:null};

export default function orderView(state = initialState, action) {
	switch(action.type) {
		case ORDER_REQUESTED:
			return {
				...state,
				loadingOfPlaceOrder: true,
				orderResult: null,
				error: null
			};
		case ORDER_SUCCESS:
