...
// let SplashScreen = require('@remobile/react-native-splashscreen');
		...
		return(
			<View style={styles.bg}>
				...
				<View style={{flex:1, flexDirection:'row',marginTop:5}}>
					...
					<TouchableOpacity onPress={()=>this._onBtnNo()} style={{flex:1,backgroundColor:'#DC754C', justifyContent:'center',alignItems:'center'}}>
						<Text style={{fontSize:20, color:'#FFF'}} >NO</Text>
					</TouchableOpacity>

					<TouchableOpacity onPress={Actions.address} style={{flex:1,backgroundColor:'#7E5D91', justifyContent:'center',alignItems:'center'}} >
