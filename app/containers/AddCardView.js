...
class AddCardView extends Component{
	...
	componentWillReceiveProps(nextProps){
		...
		if (addCardError) {
			...
			{
				let errorArray = addCardError.error.split('<br />');
