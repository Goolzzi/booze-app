...
class DeliveryStoreSplitView extends Component{
	...
	componentWillMount() {
		...
		let storeCheck_type2 = [], checkedStoreID_type2 = [];
		let storeCheck_type3 = [], checkedStoreID_type3 = [];
	...
	componentWillReceiveProps(nextProps) {
		...
		if (updatecartInfo && this.state.continueFlag == 'true') {
		...
		return(
			<SideMenu
				...
				<View style={styles.bg}>
					...
					<SearchBarView onPress={()=>this.toggle()} addFlag='true' orderPage='true'/>
					<ScrollView>
						  		...
						  		<View key={index} style={{marginBottom: 3}}>
								  	<TouchableOpacity onPress={()=>instance._onPaymentMethod(item)} style={styles.paymentStyle}>
							  			...
							  			</View>
							  			{
								  			...
								  			?	<Image source={require('../assets/images/circle_check.png')} resizeMode={Image.resizeMode.contain} style={styles.arrowImgStyle} />
								  			: 	<Image source={require('../assets/images/circle_uncheck.png')} resizeMode={Image.resizeMode.contain} style={styles.arrowImgStyle} />	
								  		}
							  		</TouchableOpacity>
							  	</View>
							)
