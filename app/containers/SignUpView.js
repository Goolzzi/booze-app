...
class SignUpView extends Component{
	...
	inputBlurred(ref) {
 	...
 	_scroll(ref, offset) {
   		setTimeout(() => {
	     let scrollResponder = this.refs.myScrollView.getScrollResponder();
						...
						<TouchableOpacity onPress={()=>dismissKeyboard()}>
					  	...
					  	<View>
					  		...
					  		<View style={{borderBottomColor:'#F1F2F2',borderBottomWidth:4}}></View>
					  		{
								...
								<View style={{flex:1, justifyContent:'center', marginLeft:10}}>
						  			<Text style={{fontSize:12,color:'#58595b'}}>The email is required.</Text>
						  			<View style={{borderBottomColor:'#F1F2F2',borderBottomWidth:4}}></View>
					  			</View> : 
					  			null
					  		}
					  	...
					  	<View>
					  		...
					  		<View style={{borderBottomColor:'#F1F2F2',borderBottomWidth:4}}></View>
					  		{
								...
								<View style={{flex:1, justifyContent:'center', marginLeft:10}}>
						  			<Text style={{fontSize:12,color:'#58595b'}}>The password is required.</Text>
						  			<View style={{borderBottomColor:'#F1F2F2',borderBottomWidth:4}}></View>
					  			</View> : 
					  			null
					  		}
					  		{
					  			this.state.password_length_err ? 
								<View style={{flex:1, justifyContent:'center', marginLeft:10}}>
						  			<Text style={{fontSize:12,color:'#58595b'}}>The password should be 6 or more characters.</Text>
						  			<View style={{borderBottomColor:'#F1F2F2',borderBottomWidth:4}}></View>
					  			</View> : 
					  			null
					  		}
					  	...
					  	<TouchableOpacity onPress={()=>dismissKeyboard()} style={{backgroundColor:'#F1F2F2', height:150, flexDirection:'column', justifyContent:'flex-start'}}>
